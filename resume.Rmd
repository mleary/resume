...
I enjoy working with data to solve business problems and build tools that help people work more efficiently.  I do this by (trying to) understand the business workflow and then applying machine learning, predicitive modeling and {insert ML buzz word here}. Previously, I worked in public policy and public relations. 
